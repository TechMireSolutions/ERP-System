...
<head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet"
        href="http://localhost:8002/skin/vendor/bootstrap4/css/bootstrap.min.css?v=<?php echo time(); ?>">
    ...
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>skin/vendor/DataTables/Responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>skin/vendor/DataTables/Buttons/css/buttons.dataTables.min.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>skin/vendor/DataTables/Buttons/css/buttons.bootstrap4.min.css">
