    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 offset-md-4">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <button type="button"  data-username="techmiresolutions" data-email="techmiresolutions@gmail.com" data-password="123456" class="btn btn-block btn-success label-left login-as mb-0-25">
                            <span class="btn-label"><i class="ti-user"></i></span>
                            <?php echo $this->lang->line('xin_admin_text');?>
                        </button>
                    </div>
                    <div class="col-xs-6">
                        <button type="button" class="btn bg-warning btn-block label-left mb-0-25 login-as" data-username="mohibali" data-email="mohibali.tms@gmail.com" data-password="123456">
