      ...
      <div class="box box-block tile tile-2 bg-primary mb-2">
        ...
        <div class="t-content">
          <h1 class="mb-1">
            ...
            <?php echo $this->Xin_model->currency_sign($all_sal[0]->paid_amount); ?>
          </h1>
  ...
  <div class="row row-md mb-1">
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
      <div class="box box-block bg-white tile tile-3 sdl-tile mb-2">
        ...
        <div class="t-content"> <span
            class="text-uppercase text-danger"><?php echo $this->lang->line('dashboard_departments'); ?></span>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
      <div class="box box-block bg-white tile tile-3 payroll-tile mb-2">
        ...
        <div class="t-content"> <span
            class="text-uppercase text-success"><?php echo $this->lang->line('dashboard_projects'); ?></span>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
      <div class="box box-block bg-white tile tile-3 payroll-tile mb-2">
        ...
        <div class="t-content"> <span
            class="text-uppercase text-primary"><?php echo $this->lang->line('dashboard_locations'); ?></span>
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
      <div class="box box-block bg-white tile tile-3 payroll-tile mb-2">
        ...
        <div class="t-content"> <span
            class="text-uppercase text-primary"><?php echo $this->lang->line('dashboard_companies'); ?></span>
    ...
    <div class="col-md-3">
      <div class="box bg-white user-1">
        <div class="u-img img-cover"
          style="background-image: url(<?php echo base_url(); ?>uploads/profile/background/<?php echo $user_info[0]->profile_background; ?>);">
        </div>
        <div class="u-content">
          <div class="avatar box-64">
            ...
            ?>
            <img class="b-a-radius-circle shadow-white" src="<?php echo $lde_file; ?>" alt=""> <i
              class="status bg-success bottom right"></i>
          </div>
          <h5><a class="text-black" href="<?php site_url(); ?>employees/detail/<?php echo $user_info[0]->user_id; ?>/">
              <?php echo $user_info[0]->first_name . ' ' . $user_info[0]->last_name; ?></a></h5>
          <p class="text-muted pb-0-5"><?php echo $role_name; ?></p>
          <p class="text-muted pb-0-5"><?php echo $this->lang->line('dashboard_last_login'); ?>:
            <?php echo $this->Xin_model->set_date_format($user_info[0]->last_login_date) . ' ' . $last_login->format('h:i a'); ?>
          </p>
            ...
            <div class="text-xs-center pb-0-5">
              <form name="set_clocking" id="set_clocking" method="post">
                ...
                <?php if ($attendances->num_rows() < 1) { ?>
                  ...
                  <button class="form-control b-a btn btn-success text-uppercase" type="submit" id="clock_btn"><i
                      class="fa fa-arrow-circle-right"></i> <?php echo $this->lang->line('dashboard_clock_in'); ?></button>
                <?php } else { ?>
                  ...
                  <button class="form-control b-a btn btn-warning text-uppercase" type="submit" id="clock_btn"><i
                      class="fa fa-arrow-circle-left"></i> <?php echo $this->lang->line('dashboard_clock_out'); ?></button>
                <?php } ?>
              </form>
            </div>
          <?php } ?>
        ...
        <div class="u-counters">
          <div class="row no-gutter">
            <div class="col-xs-12 uc-item"> <a class="text-black" href="javascript:void(0);">
                <?php echo $office_shift; ?></a> </div>
          </div>
        </div>
      </div>
    </div>
                ...
                foreach ($aim as $dIds) {
                  if ($session['user_id'] === $dIds) {
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="m-b-0-5"><?php echo $this->lang->line('dashboard_completed'); ?> <span
                            class="pull-xs-right"><?php echo $pj->project_progress; ?>%</span></p>
                        <progress class="progress <?php echo $progress_class; ?> progress-sm d-inline-block mb-0"
                          value="<?php echo $pj->project_progress; ?>"
                          max="100"><?php echo $pj->project_progress; ?>%</progress>
                      </td>
                    </tr>
                  <?php }
                } ?>
  ...
  <?php if ($user_info[0]->user_role_id == '1') { ?>
    <div class="col-md-6">
      <div class="card box box-block bg-white">
        <h2><strong><?php echo $this->lang->line('dashboard_new'); ?></strong>
          <?php echo $this->lang->line('dashboard_employees'); ?></h2>
        <?php foreach ($last_four_employees as $employee) { ?>
          ...
          <div class="items-list">
            <div class="il-item" style="padding:0.63rem 1.25rem;"> <a class="text-black"
                href="<?php echo site_url(); ?>employees/detail/<?php echo $employee->user_id; ?>/">
                <div class="media">
                  <div class="media-left">
                    <div class="avatar box-48"> <img class="b-a-radius-0-125" src="<?php echo base_url() . $de_file; ?>"
                        alt=""> </div>
                  </div>
        ...
        <?php } ?>
        <div class="card-block"> <a class="btn btn-primary btn-block"
            href="<?php site_url(); ?>employees"><?php echo $this->lang->line('dashboard_show_more'); ?></a> </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card box box-block bg-white">
        <h2><strong><?php echo $this->lang->line('dashboard_recruitment'); ?></strong>
          <?php echo $this->lang->line('dashboard_timeline'); ?></h2>
        <div class="">
            ...
            <?php foreach ($last_jobs as $job_apps): ?>
              ...
              <div class="n-item" style="margin-bottom: 0;">
                <div class="media">
                  ...
                  <div class="media-body">
                    <div class="n-text"><strong><?php echo $candidate_name; ?></strong> <span
                        class="text-muted"><?php echo $this->lang->line('dashboard_applied_for'); ?> </span>
                      <strong><?php echo $job_title; ?></strong> <?php echo $this->lang->line('dashboard_position'); ?>
                    </div>
  ...
  <div class="row m-b-1">
    <div class="col-md-12">
      <div class="box box-block bg-white">
        ...
        <h2><strong><?php echo $this->lang->line('dashboard_today_attendance'); ?> - <span id="att_date">
              <?php echo $edate = $this->Xin_model->set_date_format(date('d M, Y')); ?></strong></span> </h2>
        <div class="table-responsive" data-pattern="priority-columns">
  ...
  <div class="row row-md mb-1">
                ...
                foreach ($aim as $dIds) {
                  if ($session['user_id'] === $dIds) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $status; ?></td>
                      <td>
                        <p class="m-b-0-5"><?php echo $this->lang->line('dashboard_completed'); ?> <span class="pull-xs-right">
                            <?php echo $et->task_progress; ?>%</span></p>
                        <progress class="progress <?php echo $progress_class; ?> progress-sm d-inline-block mb-0"
                          value="<?php echo $et->task_progress; ?>" max="100"><?php echo $et->task_progress; ?>%</progress>
                      </td>
                    </tr>
                  <?php }
                } ?>
    ...
    <div class="col-md-3">
      <div class="box box-block bg-white tile tile-3 mb-2">
        <div class="t-content">
          <h6 class="text-uppercase text-danger"><?php echo date('F'); ?>
            <?php echo $this->lang->line('dashboard_attendance'); ?>
          </h6>
          <?php
          $m = date('m');
          $y = date('Y');
          ...
          ?>
          <?php
          $attendance_count = $this->Xin_model->current_month_attendance();
          if (!is_array($attendance_count) && !($attendance_count instanceof Countable)) {
            $attendance_count = [];
          }
          ?>
          <h1 class="mb-0"><?php echo count($attendance_count); ?>/<?php echo $numDays; ?></h1>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="box box-block bg-white tile tile-3 mb-2">
        <div class="t-content">
          ...
          <?php
          $awards_count = $this->Xin_model->total_employee_awards();
          if (!is_array($awards_count) && !($awards_count instanceof Countable)) {
            $awards_count = [];
          }
          ?>
          <h1 class="mb-0"><?php echo count($awards_count); ?></h1>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="card box box-block bg-white" style="overflow-y: overlay; height: 242px;">
        ...
        <div class="">
          <div>
            ...
            $dId = array();
            $i = 1;
            foreach ($announcement->result() as $an):
              if ($an->department_id == $department_id) {
                ...
                <div class="n-item" style="margin-bottom: 0;">
                  <div class="media">
                    <div class="media-body">
                      <div class="n-text"><strong><?php echo $an->title; ?></strong> <span class="text-muted"
                          style="float:right;"><?php echo $andate; ?> </span></div>
                    </div>
                  </div>
                </div>
                <hr>
          ...
          <div>
            ...
            foreach ($this->Xin_model->get_employee_awards() as $emp_award):
              ...
              <div class="n-item" style="margin-bottom: 0;">
                <div class="media">
                  <div class="media-body">
                    <div class="n-text"><strong><?php echo $aw_name[0]->award_type; ?></strong> <span class="text-muted"
                        style="float:right;"><?php echo $awdate; ?> </span></div>
                  </div>
                </div>
              </div>
              <hr>
