                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="select2" data-plugin="select_hrm"
                          ...
                          <option value=""></option>
                          <?php if (isset($all_warning_types)): ?>
                            <?php foreach ($all_warning_types as $warning_type) { ?>
                              <option value="<?php echo $warning_type->warning_type_id ?>"><?php echo $warning_type->type; ?>
                              </option>
                            <?php } ?>
                          <?php endif; ?>
                        </select>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control date"
                          placeholder="<?php echo $this->lang->line('xin_warning_date'); ?>" readonly name="warning_date"
                          type="text">
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control textarea"
                      placeholder="<?php echo $this->lang->line('xin_description'); ?>" name="description" cols="30"
