...
$config['smtp_host'] = 'ssl://smtp.gmail.com';   // Gmail SMTP
$config['smtp_user'] = 'YOUR_EMAIL@gmail.com';   // REPLACE THIS
$config['smtp_pass'] = 'YOUR_APP_PASSWORD';      // REPLACE THIS (Use App Password)
